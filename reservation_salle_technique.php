							...
							<form action="save_tecnical_schedule.php" method="post" id="schedule-form">
								...
								<div class="form-group mb-2">
									...
									<input type="datetime-local" class="form-control form-control-sm rounded-0"
										name="start_datetime" id="start_datetime" required step="1800">
								</div>
									<div class="form-group mb-2">
									<label for="end_datetime" class="control-label">Fin</label>
									<input type="datetime-local" class="form-control form-control-sm rounded-0"
										name="end_datetime" id="end_datetime" required step="1800">
								</div>
								<div class="form-group mb-2">
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="option"
											id="option_rite_musulman" value="Rite musulman" required>
